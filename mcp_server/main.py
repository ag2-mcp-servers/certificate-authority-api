...
#   timestamp: 2025-06-29T02:38:24+00:00
...
app = MCPProxy(
    ...
    version='v1beta1',
    servers=[{'url': 'https://privateca.googleapis.com/'}],
)
...
@app.delete(
    ...
    tags=['privateca_iam_policy_management'],
    security=[
...
@app.get(
    ...
    tags=[
        'privateca_operation_management',
        'privateca_iam_policy_management',
        'iam_permission_validation',
    ],
    security=[
        UnsuportedSecurityStub(name="None"),
        UnsuportedSecurityStub(name="None"),
...
@app.get(
    ...
    tags=['privateca_operation_management', 'privateca_iam_policy_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        UnsuportedSecurityStub(name="None"),
    ],
...
@app.post(
    ...
    tags=['privateca_operation_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        UnsuportedSecurityStub(name="None"),
    ],
...
@app.get(
    ...
    tags=['privateca_iam_policy_management', 'iam_permission_validation'],
    security=[
        UnsuportedSecurityStub(name="None"),
        UnsuportedSecurityStub(name="None"),
    ],
...
@app.post(
    ...
    tags=['iam_permission_validation', 'privateca_iam_policy_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        UnsuportedSecurityStub(name="None"),
    ],
